...
<head>
    <meta charset="UTF-8">
    <title>Univ Manager - BTS</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        /* DESIGN STRICTEMENT IDENTIQUE A TA CAPTURE */
                    ...
                    <tbody>
                        <?php if($total > 0): ?>
                            ...
                            <tr>
                                ...
                                <td><span class="badge bg-success">Libre</span></td> <!-- Statique -->
                                <td>
                                    <button class="btn btn-sm btn-outline-primary border-0"><i class="fa-solid fa-pen"></i></button>
                                    <button class="btn btn-sm btn-outline-danger border-0"><i class="fa-solid fa-trash"></i></button>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
                            <tr><td colspan="4" class="text-center text-muted py-5">Aucune salle enregistrée pour le niveau BTS.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
...
<!-- Script Bootstrap nécessaire pour le menu déroulant -->
