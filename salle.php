...
if(isset($_POST['btn_save'])) {
    if(!empty($_POST['nom']) && !empty($_POST['code']) && !empty($_POST['cap'])) {
        ...
        header("Location: salle_licence.php");
        exit();
    }
}
...
<head>
    <meta charset="UTF-8">
    <title>Univ Manager - LICENCE</title>
            ...
            <div class="card-form">
                ...
                <div class="p-3">
                    <form method="POST">
                        ...
                        <input type="text" name="nom" class="form-control" placeholder="AMPHI A" required>
                        <label class="label-custom">IDENTIFIANT</label>
                        <input type="text" name="code" class="form-control" placeholder="LIC-01" required>
                        <label class="label-custom">CAPACITÉ</label>
                        <input type="number" name="cap" class="form-control" placeholder="100" required>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <?php if($total > 0): ?>
                            ...
                            <?php endforeach; ?>
                        <?php else: ?>
                            <tr><td colspan="4" class="text-center text-muted py-5">Aucune salle Licence.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
